                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="skill_name" id="skill_name" placeholder="Skill Name" value="{{ $skill->skill_name }}" required>
                                @error('skill_name')
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <select class="form-select form-select-lg" name="skill_level" id="skill_level" placeholder="Skil Level" required>
                                    <option value="good" @if ($skill->skill_level == "good")
                                    selected
                                @endif>Good</option>
                                    <option value="very good" @if ($skill->skill_level == "very good")
                                        selected
                                    @endif>Very Good</option>
                                    <option value="excellent" @if ($skill->skill_level == "excellent")
                                        selected
