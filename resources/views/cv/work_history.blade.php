    ...
    <div class="container center-form-layout">
        <div class="row justify-content-center align-items-center">
            <div class="col-11 col-md-7 col-lg-6 rounded shadow px-4 py-5 border bg-white">
                ...
                <form action="{{ route('history.create', ['cv' => $cv]) }}" method="post">
                    @csrf
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="job_title" id="job_title" placeholder="Job Title" value="{{ old('job_title') }}" required>
                                    @error('job_title')
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="employer" id="employer" placeholder="Employer" value="{{ old('employer') }}" required>
                                    @error('employer')
                                        <small class="text-danger fw-normal">{{ $message }}</small>
                                    @enderror
                                </div>
